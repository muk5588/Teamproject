...
public class UserPaging {
	...
	public UserPaging(int totalCount, int curPage) {
	...
	public UserPaging(int totalCount, int curPage, int listCount, int pageCount) {
		setTotalCount(totalCount);
		setCurPage(curPage);
	...
	private void makePaging() {
		...
		if(listCount == 0) setListCount(15); // 화면에 보일 게시글 수 기본값
