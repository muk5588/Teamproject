...
<div class="wrap mx-auto">
	...
	<%-- </colgroup> --%>
		...
		<c:forEach var="board" items="${list }">
			<tr>
				<td class="checkbox"><input type="checkbox" value="${board.boardNo }" name="deleteNum" class="delCheckBox"></td>
				...
				<c:forEach var="map" items="${totalrecomm }">
					<c:if test="${map.BOARDNO eq board.boardNo }">
						<td class="recommend">${map.get("RECOMMEND") }</td>
					</c:if>
				</c:forEach>
			</tr>
		</c:forEach>
			<tr>
				<td><button id="deleteBtn">체크 삭제</button></td>
			</tr>
	</table>
