...
<p class="bold-text">이용자는 회원가입을 하지 않아도 정보 검색, 뉴스 보기 등 대부분의 Travel Square 서비스를 회원과 동일하게 이용할 수 있습니다.</p>
<p class="bold-text">이용자가 메일, 캘린더, 카페, 블로그 등과 같이 개인화 혹은 회원제 서비스를 이용하기 위해 회원가입을 할 경우, Travel Square는 서비스 이용을 위해 필요한 최소한의 개인정보를 수집합니다.</p>
